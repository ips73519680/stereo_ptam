...
class ImageReader(object):
    def __init__(self, ids, timestamps, cam=None,config=None):
        self.ids = ids
    ...
    def read(self, path):
        # if(self.config=='Superpoint-Superpoint'):
        #     img_size = (640, 480)
...
class KITTIOdometry(object):   # without lidar
    '''
    path example: '/home/b08505024/stereo_ptam-master/dataset/KITTI/dataset/sequences/00'
    '''
